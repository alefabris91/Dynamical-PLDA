...
[X_gal, X_probe,X_gal_IDs,X_probe_IDs]=Utils.getGalleryProbeFrom(X_train,X_train_IDs,j_probe,'X_ext',X_Ext,'Num_ext',numExtVids);
...
N=T_train;
[X_PLDA_train, identities_PLDA_train]=PreprocessData4PLDA(X_gal,X_gal_IDs,N,0);
...
[ conditionalLogLiks_probe, identities ] = identifyLongKalman_MO_parfor( A_est,F_est,G_est,Sigma_est,mu_est, X_gal,X_gal_IDs , X_probe,T_gal,Dh,Dw,1);
